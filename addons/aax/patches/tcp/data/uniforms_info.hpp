#define Macro_Zephyr_AAX_TCP_CBUU_TShirt(ArgCamo)\
...
#define Macro_Zephyr_AAX_TCP_CBUU_All(ArgCamo)\
	...
	Macro_Zephyr_AAX_TCP_CBUU_TacShirt(ArgCamo)\
	Macro_Zephyr_AAX_TCP_CBUU_FieldTop(ArgCamo)
