...
- [Visual Sudio Code](https://code.visualstudio.com/) config editing, you may use codium or any other editor just be aware that getting the addons may be harder
