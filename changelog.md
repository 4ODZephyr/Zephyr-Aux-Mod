...
## Unreleased
### Changed
- MOLOT Group - Lapa Hood now has inventory space for its backpack varient
  - also added an NVG version with thermals

## 1.9.0
### Changed
- Rename the LAGO_Biken to have a more fitting UNSC style name

## 1.8.0
### Added
- Ability to pick up rocks via ACE self interact
